...
?>
	...
	<footer id="colophon" class="site-footer clear">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 55.25"><defs><style>.cls-1{fill:var(--bg);}</style></defs><title>triangle-uneven-top</title><g id="Layer_3" data-name="Layer 3"><polygon class="cls-1" points="500 55.24 375.51 19.02 0 55.24 0 0 500 0 500 55.24"/></g></svg>
